...
var app=angular.module('authApp', [ 'oc.lazyLoad',
		...
		/*  $ocLazyLoadProvider.config({
			...
			.state('home', {
				...
				.state('admindashboard.cancellationlist', {
				 url: '/cancellationlist',
			
				})
				.state('admindashboard.refundlist', {
				 url: '/refundlist',
			...
			.state('mysettings.account', {
				 url: '/account',

				})
			.state('mysettings.changepassword', {
			 url: '/changepassword',
			
		
			})
			.state('mysettings.autoresponder', {
			 url: '/autoresponder',
			
		
			})
			.state('mysettings.subscription', {
			 url: '/subscription',
			
		
			})
			/*.state('mysettings.subscr-success', {
