...
<div class="container" data-ng-controller="demoController">
    ...
    <ul class="nav nav-pills">
        <li data-ng-class="{active: getLocale() === 'en'}"><a data-ng-click="setLocale('en')">English</a></li>
        <li data-ng-class="{active: getLocale() === 'de'}"><a data-ng-click="setLocale('de')">German</a></li>
        <li data-ng-class="{active: getLocale() === 'zh-cn'}"><a data-ng-click="setLocale('zh-cn')">Chinese</a></li>
    </ul>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <p><code>dropdownSelector: '#dropdown1'</code> to toggle the dropdown.</p>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <p><code>data-on-set-time='inputOnTimeSet()'</code> to toggle the dropdown.</p>
            ...
            <div class="well">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                        <datetimepicker data-ng-model="data.inputOnTimeSet"
                                        data-on-set-time="inputOnTimeSet(newDate)"></datetimepicker>
                    </ul>
                </div>
            </div>
        </div>
