...
class IContactApi {
    ...
    /**
     * This method search for an email address
     * in provided list
     * GET requests to the iContact API
     * @access public
     * @param string $email
     * @param interger $listId
     * @return array contactObject on sucess else empty array
     * */
    public function getContactWithEmailList($email, $listId) {
        // Make the call and return the data
        $this->aSearchParameters['status'] = 'total';
        $this->aSearchParameters['email'] = $email;
        $this->aSearchParameters['listId'] = $listId;
